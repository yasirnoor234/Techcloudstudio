...
if ( ! function_exists( 'business_point_is_breadcrumb_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function business_point_is_breadcrumb_active( $control ) {

		if ( 'simple' == $control->manager->get_setting( 'breadcrumb_type' )->value() ) {
			return true;
		} else {
			return false;
		}
